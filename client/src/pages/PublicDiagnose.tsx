...
const externalPanelMeta: Record<ExternalPanelResult, ResultMeta> = {
  ...
  no: { label: "PAINEL NÃO IDENTIFICADO", description: () => "Nenhuma combinação técnica suficiente foi achada nas fontes passivas avaliadas.", tone: "border-emerald-300/25 bg-emerald-300/[.07]", badge: "bg-emerald-300/15 text-emerald-100 ring-1 ring-emerald-300/25" },
